...
func (d *Daemon) Start(ctx context.Context) error {
	...
	mux.Handle("/api/profile/publish", d.withOptionalAuth(http.HandlerFunc(d.handleProfilePublish)))
	mux.Handle("/api/profile/", d.withOptionalAuth(http.HandlerFunc(d.handleProfileGet)))
	mux.Handle("/api/profile", d.withOptionalAuth(http.HandlerFunc(d.handleProfileGet)))
	mux.Handle("/api/ans/register", d.withOptionalAuth(http.HandlerFunc(d.handleANSRegister)))
	mux.Handle("/api/ans/resolve", d.withOptionalAuth(http.HandlerFunc(d.handleANSResolve)))
	mux.Handle("/api/ans/lookup", d.withOptionalAuth(http.HandlerFunc(d.handleANSLookup)))
